...
class LandingPage extends Component {
    componentDidMount() {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            M.Slider.init(elems, { fullWidth: true });
        });
        document.addEventListener('DOMContentLoaded', function() {
    ...
    render() {
        return (
            <div className={'background ' + CSS.test}>
                ...
                <div className={`container ${CSS.mainColor}`}>
                    <div className="row">
                  ...
                  में मुख्यमंत्री श्री मनोहर लाल जी की अध्यक्षता में अपने निवास स्थान पर भाजपा का दामन थामा ।</li></p>
                   ...
                   jind |</li></p>
                        ...
                        <div className="col s12 m4 l3"><h2>photo</h2>
                            <div >
                                <img className={'materialboxed' + CSS.image} shadow={5} src={image}></img>
                            </div>
                            <div style={{ paddingTop: '170px' }}>
                                <img className={'materialboxed' + CSS.image} shadow={5}  src={image1}></img>
                            </div>
                            <div  style={{ paddingTop: '170px' }}>
                                <img className={'materialboxed' + CSS.image} shadow={5} src={image4}></img>
                            </div>
                            <div  style={{ paddingTop: '80px' }}>
                                <img className={'materialboxed' + CSS.image} shadow={5}src={image3}></img>
                            </div>
                        </div>
                    </div>
                </div>
